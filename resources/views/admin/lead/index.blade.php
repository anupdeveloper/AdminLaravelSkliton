...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <br><br>
        <div class="col-md-10 offset-1 adv-filter">
            ...
            <form id="filter-form" name="filter-form" action="{{route('admin.lead.getdata')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <label>Chimney Status</label>
                        <select class="form-control" id="chimney_status" name="chimney_status">
                    ...
                    <div class="col-md-2">
                        <label>Waterpurifier Status</label>
        ...
        <div class="table-responsive">
            ...
            <table id="userMGMT" class="table table-bordered  data-table">
                ...
                <tr>
                    ...
                    <th>Chimney Status</th>
                    <th>WaterPurifier Status</th>
                    <th>Status/Assign Date</th>
                    <th>Feedback</th>
                    <th>DateTime</th>
