...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="actions-btn">
            {{-- <a class="btn btn-primary sm-btn" href="{{route("admin.workorder.add")}}" >Add New</a> --}}
            @if(empty($wo_type))
            <a class="btn btn-primary sm-btn" href="{{route("admin.workorder.add_work_order")}}" >Technician Assignment</a>
            @endif
        </div>
        ...
        <div class="table-responsive">
            <table id="userMGMT" class="table table-bordered  data-table">
                <thead>
                <tr>
                    <th>WorkOrder No./Ticket No.</th>
                    <th>Title</th>
                    <th>Desc</th>
                    <th>Technician/Customer</th>
                    <th>Slot/Status</th>
                    <th>DateTime</th>
       ...
       $('.check-all').click(function() {
        ...
        $(function () {
            ...
            var oTable = $('.data-table').DataTable({
                ...
                "stateSave": true,
                ajax: {
                    url: "{{ route('admin.workorder.getdata',$wo_type) }}",
                },
                columns: [
                    {data: 'work_order_detail', name: 'work_order_detail'},
        ...
        function delete_row(id) {
            ...
            if (confirm('Are you sure?')) {
                ...
                $.ajax({
                    ...
                    type: "post",
                    url: "{{ route('admin.workorder.destroy') }}",
                    data:
                        {
                            id: id
                        },
                    ...
                    success: function (data) {
                        ...
                        alertify.success('You have successfully deleted this Workorder!!');
