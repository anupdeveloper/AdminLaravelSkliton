...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="actions-btn">
            <a class="btn btn-primary sm-btn" href="{{route("admin.ticket.add")}}" >Add New</a>
        </div>
        ...
        <div class="table-responsive">
            <table id="userMGMT" class="table table-bordered  data-table">
                ...
                <tr>
                    <th>Ticket No</th>
                    <th>Customer Name/Mobile/Type</th>
                    <th>Title</th>
                    <th>Desc</th>
                    <th>Status / Technician Detail</th>
       ...
       $('.check-all').click(function() {
        ...
        $(function () {
            ...
            var oTable = $('.data-table').DataTable({
                ...
                "searchable": true,
                ajax: {
                    url: "{{ route('admin.ticket.getdata') }}",
                },
                columns: [
        ...
        function delete_row(id) {
            ...
            if (confirm('Are you sure?')) {
                ...
                $.ajax({
                    ...
                    type: "post",
                    url: "{{ route('admin.ticket.destroy') }}",
                    data:
                        {
                            id: id
                        },
                    ...
                    success: function (data) {
                        ...
                        alertify.success('You have successfully deleted this Ticket!!');
