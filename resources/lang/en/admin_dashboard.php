...
return [
    ...
    "sidebar_menu" => [
        "user_management" => "User Manangement",
        ...
        "active_connections" => "Active Connection",
        "request_connections" => "Requested Connection",
        "cancel_connections" => "Cancel Connection",
        "requested_suggestion" => "Requested Suggestion",
        "settings" => "Settings",
        "master_education" => "Education",
        "master_skin_color" => "Skin color",
        "master_personality_dimension" => "Personality dimenstions",
        "master_onboarding" => "OnBoarding",
        "master_subscription" => "Subscription Packages",
        "master_status" => "Status",
        "master_education_content" => "Educational Content",
        "master_hijab_type" => "Hijab Type",
        "master_work" => "Master Work",
        "master_family_origin" => "Family Origin",
        "master_children" => "Master Children",
        "master_popup_message" => "Master POPUp message",
        "master_sect" => "Master Sect",
        "master_reason" => "Master Reason",
        "master_height" => "Master Height",
        "terms_n_condition" => "Terms & Condition",
        "vat_setting" => "Settings",
    ...
    "admin" => [
        ...
        "TermsCondition" => [
            "labels" => [
                "title_en" => "Name en",
                "title_ar" => "Name ar",
                "content_en" => "Description en",
                "content_ar" => "Description ar",
        ...
        "Connection" => [
            "title" => "Connection",
            "labels" => [
                "connection_form"=>"Connection From",
