...
class StaffController extends Controller
{
    ...
    public function view_reports(Request $request, $user_id)
    {
        ...
        return view('admin.staff.user_report', [
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $user = User::select('*')
                ...
                ->whereIn('user_type', ['tele_caller','technician']);
            ...
            if (1) {
                ...
                return Datatables::of($user)
                    ...
                    ->addColumn('action', function ($row) {
                        ...
                        href="' . route("admin.staff.edit", ["id" => $row->id]) . '"><i class="fas fa-pencil-alt"></i></a>';
        ...
        // load the view and pass the user
        return view('admin.staff.user_index', [
            // //'user_list' => $data,
        ]);
    }
   ...
   public function create()
   {
        ...
        $user_types = [
            'tele_caller','technician'
        ];
        return view('admin.staff.user_create', [
   ...
   public
    ...
    function edit($id)
    {
        ...
        return view('admin.staff.user_edit', [
            'page_title' => $page_title,
            'user_types' =>$user_types,
            'data' => $data,
        ]);
